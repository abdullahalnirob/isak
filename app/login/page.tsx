      ...
      <div className="relative w-full max-w-md">
        <div className="rounded-3xl border border-rose-100/80 bg-white/80 p-10 shadow-xl shadow-rose-900/5 backdrop-blur-xl sm:p-12">
          <div className="flex flex-col items-center gap-6">
            ...
            <button className="flex w-full items-center justify-center gap-3 rounded-full border border-slate-200 bg-white px-6 py-3.5 text-[15px] font-semibold text-slate-700 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50 hover:shadow-md">
              <GoogleIcon />
